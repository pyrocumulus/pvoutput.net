...
namespace PVOutput.Net.Objects
{
    ...
    public interface IOutputPost
    {
        ...
        /// <summary>
        /// Peak energy export on the output date.
        /// </summary>
        int? PeakEnergyExport { get; set; }

        /// <summary>
        /// Off peak energy export on the output date.
        /// </summary>
        int? OffPeakEnergyExport { get; set; }

        /// <summary>
        /// Shoulder energy export on the output date.
        /// </summary>
        int? ShoulderEnergyExport { get; set; }

        /// <summary>
        /// High shoulder energy export on the output date.
        /// </summary>
        int? HighShoulderEnergyExport { get; set; }
    }
}
